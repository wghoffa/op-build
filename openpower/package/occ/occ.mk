...
OCC_VERSION_BRANCH_MASTER ?= a43395b0328e9af2be16bbe85dcc6b692d0fe6a7
...
define OCC_BUILD_CMDS_P9
        cd $(@D)/src && \
        make PPE_TOOL_PATH=$(PPE42_GCC_BIN) OCC_OP_BUILD=1 CROSS_PREFIX=$(TARGET_CROSS) LD_LIBRARY_PATH=$(HOST_DIR)/usr/lib OPOCC_GPU_SUPPORT=1 all 
endef
